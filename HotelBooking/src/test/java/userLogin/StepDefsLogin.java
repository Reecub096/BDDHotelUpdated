...
private hotelLoginPageFactory hlpf;
	...
	public void navigate_to_hotel_page() throws Exception {
	    // Write code here that turns the phrase above into concrete actions
		driver.navigate().to("file:///D:/Softwares/hotelBooking/hotelbooking.html");
		Thread.sleep(2000);
	//driver.close();
	}
 ...
 //driver.close();
	...
	@Then("^display login failed messag$")
	public void display_login_failed_messag() throws Throwable {
	    // Write code here that turns the phrase above into concrete actions
